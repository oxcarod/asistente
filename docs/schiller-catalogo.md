---
name: schiller-catalogo
description: Catálogo completo de equipos médicos SCHILLER Latam — electrocardiógrafos, espirometría, ergómetros, emergencias, rehabilitación cardiaca
type: reference
---

# SCHILLER Latam — Catálogo de Equipos Médicos

## Información de la Empresa

**Nombre:** SCHILLER Americas
**Años en el mercado:** 50 años innovando con equipos médicos de alta tecnología
**Origen:** Suiza
**Fundador:** Alfred Schiller
**Inventos clave:** Teclados ECG, impresoras integradas, funciones de interpretación de pruebas
...
### 1. Electrocardiógrafos (ECG)

Los electrocardiógrafos SCHILLER son el corazón del catálogo. Destacan por frecuencia de muestreo de hasta 32,000 Hz (vs. 500-1,000 Hz típico en ECG convencionales), lo que permite mayor precisión diagnóstica.
...
- Combina ECG de esfuerzo con análisis de gases (ergoespirometría)
...
- Alimentador de corriente alterna + batería interna
- Formato de exportación: PDF, SCP, XML, HL7
...
- Ideal para laboratorios de función pulmonar completos
...
- Diseñado para niños, adultos y adultos mayores
- Mejora la eficiencia de la consulta — no requiere equipo separado
...
- **PEF** (Pico de Flujo Expiratorio)
- **FEF25-75%** (Flujo Mediano)
- **TLC** (Capacidad Pulmonar Total) — solo con pletismografía
- **RV** (Volumen Residual) — solo con pletismografía
- **DLCO** (Transferencia de monóxido de carbono) — en algunas configuraciones
...
- Velocidad y ángulo de incline ajustables
...
- Compatible con todos los ECG de esfuerzo SCHILLER
- **Opción de medición SpO2** integrada
- Ajuste de carga en vatios (W)
- Regulación de potencia precisa
- Posición del sillín ajustable
- Manillar multifunción con agarre para ECG de 12 derivaciones

---

### 4. Ergoespirometría / Pruebas de Esfuerzo
...
- Funciones automatizadas que ahorran tiempo
...
- **Monitores multiparamétricos** para uso hospitalario
- Parámetros: ECG, SpO2, NIBP, temperatura, respiración
- Alarmas configurables
- Pantalla a color de alta resolución
- Conectividad LAN / Wi-Fi
- Batería de respaldo
...
- Guía de voz en español e idiomas múltiples
- Diseño compacto y portátil
- Batería de larga duración
- Electrodos pre-conectados
- Auto-test periódico
- Indicadores visuales ysonoros de estado
...
- Autotest periódicos远程监控
- Geolocalización del evento
- Historial de uso accesible desde la nube
- Alertas a servicios de emergencias
...
- Sin descarga real — seguro para entrenamiento
...
- Guía al reanimador en los 3 parámetros críticos:
  ...
  2. **Frecuencia correcta** — 100-120 compresiones/min
  3. **Presión correcta** — profundidad adecuada del pecho
- Diseñado para que **cualquier persona** lo use, sin entrenamiento previo
- Señal sonora y visual
- Compacto y ligero
- Se coloca sobre el esternón del paciente
- Muy bajo costo vs. un DEA
...
- **Ideal para:**
  - Espacios reducidos (ambulancias, UCI móvil)
  - Estudios de imagen (TAC, resonancia magnética — verificar modelo específico)
  - Transporte de pacientes durante RCP
- Libre de pistón — usa banda de compresión
- Indicador de calidad de compresión
- Batería de respaldo
- Reemplaza la necesidad de compresiones manuales (fatiga del reanimador)
...
- **Capacidades:**
  - Monitoreo de múltiples pacientes simultáneamente
  - Estándares de calidad para rehabilitación cardiaca
  - Registro de ejercicios y signos vitales por paciente
  - Generación de reportes de evolución
  - Configuración de programas de ejercicio personalizados
- **Integración:** compatible con ergómetros y monitores SCHILLER
- **Aplicaciones:** hospitales, clínicas de rehabilitación, centros especializados
...
- Autotest periódicos y reportes de estado de equipos
- Geolocalización de eventos
- Alertas a servicios de emergencia
- Historial de uso y mantenimiento de equipos
...
- Conectividad HL7 / GDT para integración con sistemas hospitalarios (HIS)
...
- Utilizado en pruebas de función pulmonar para diagnosticar asma y EPOC
- Nebulizador integrado
- Medición de flujo espiratorio antes y después del broncodilatador
...
## Ventajas Competitivas de SCHILLER

1. **Frecuencia de muestreo 32x superior** al estándar (32,000 Hz) — mayor precisión diagnóstica
2. **Integración** — los ECG pueden convertirse en ergoespirómetros añadiendo módulos
3. **Origen suizo** — percepción de alta calidad y confiabilidad
4. **LifeDataNet G2** — único sistema de monitoreo remoto de DEAs en el mercado LATAM
5. **RCP mecánica Easy Pulse** — diferenciador para servicios de emergencia y traslado
6. **Cardio First Angel** — producto de entrada de bajo costo para cardioprotección普及
7. **Sana Sprint Plus** — gestión grupal de rehabilitación, ventaja competitiva en hospitales

---

## Contacto Comercial

- **Empresa:** SCHILLER Americas
- **Email:** info@schilleramericas.com
- **Teléfono:** +52 1 56 1545 8856 (México)
- **Sitio web:** https://schillerlatam.com
- **Catálogo online:** https://schillerlatam.com/catalogo/
